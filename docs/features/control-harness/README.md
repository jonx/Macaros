...
| `media [list\|grant NODE [--rw]\|revoke NAME\|status]` | Choose which physical host disk or stick AROS may see. Granting unmounts the volume on the macOS side and writes its AROS mount description. See [host-media](../host-media/README.md). |
